...
**Packaging:**
```bash
source v2/.env/bin/activate && cd v2 && python scripts/package_executable.py
source v2/.env/bin/activate && cd v2 && python scripts/package_executable.py --skip-rust-build  # skip Rust rebuild
```
